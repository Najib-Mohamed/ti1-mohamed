    ...
    <div class="body-contaier">
        ...
        <main>
            ...
            <div class="text-conteneur">
                <h2 class="text-general">Du Néolithique à l'Empire romain</h2>
                ...
                <h2 class="text-general">Conquête musulmane</h2>
                <p class="text-justify text-general">
                ...
                <p class="text-justify text-general">
                    L'arabe est imposé comme langue officielle. Le mozarabe reste parlé par la population chrétienne. L'islam est la religion officielle, pratiquée par les Maures et les muladís, alors que chrétiens et juifs peuvent pratiquer leur religion, en qualité de dhimmis, à condition d’acquitter la djizîa, impôt différent de la zakât à laquelle est soumise la population musulmane.</p>
                <p class="text-justify text-general">
                    En 844, Lisbonne est assiégée par les Vikings. La ville, bien protégée, aurait résisté aux assaillants, mais en 858, de nouveau attaquée par les pirates scandinaves, elle est prise et pillée par le chef viking Hasting. En 966, vingt-huit navires vikings attaqueront une nouvelle fois Lisbonne, sans succès.
                </p>
                <p class="text-justify text-general">
                ...
                <h2 class="text-general">Du Moyen Âge à l'Empire portugais</h2>
                <p class="text-justify text-general">
                ...
                <h2 class="text-general">xixe et xxe siècles</h2>
                <p class="text-justify text-general">
                ...
                <h2 class="text-general">Lisbonne contemporain</h2>
                <p class="text-justify text-general">
